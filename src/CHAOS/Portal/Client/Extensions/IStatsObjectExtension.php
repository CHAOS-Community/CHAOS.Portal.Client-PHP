<?php
	...
	interface IStatsObjectExtension
	{
		 ...
		 * @param string|null $objectTitle An optional title for the StatsObject. Only set first time StatsObject/Set is called with a new ObjectIdentifier.
		 * @param string|null $ip IP address of end user.
		 * @param string|null $city Cityname of end user.
		 * @param string|null $country Country of end user.
